...
CURRENT_YEAR = 2025
RETIREMENT_AGE = [RETIREMENT_AGE]  # 例: 65
...
if __name__ == '__main__':
    print("="*60)
    print("個人情報設定ファイル (python.config.personal) - テンプレート")
    print("="*60)
    print("\n【基本情報】")
